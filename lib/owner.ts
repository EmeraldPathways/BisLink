...
export function normalizeBusiness(record: Record<string, unknown>): BusinessProfile {
  ...
  return {
    ...
    bookings_image_url: asNullableString(record.bookings_image_url),
    bookings_title: asNullableString(record.bookings_title),
    bookings_subtitle: asNullableString(record.bookings_subtitle),
    products_image_url: asNullableString(record.products_image_url),
    products_title: asNullableString(record.products_title),
    products_subtitle: asNullableString(record.products_subtitle),
    about_image_url: asNullableString(record.about_image_url),
    about_title: asNullableString(record.about_title),
    about_subtitle: asNullableString(record.about_subtitle),
    contact_image_url: asNullableString(record.contact_image_url),
    contact_title: asNullableString(record.contact_title),
    contact_subtitle: asNullableString(record.contact_subtitle),
