...
export const businessAreaKnowledgeRegistry: BusinessAreaKnowledge[] = [
  {
    ...
    summary: 'Owner dashboard link editor for hero, announcement, bookings, products, portfolio, about, contact, and page settings.',
    ...
    supportedActions: ['edit hero content', 'change slug', 'upload section images', 'update public page sections'],
    ...
    keywords: ['link editor', 'public page', 'hero image', 'cover image', 'slug', 'about section', 'live page', 'old content'],
  ...
  },
  {
    ...
    domain: 'frontend_expert',
    title: 'Services',
    summary: 'Owner service management for names, prices, durations, activity state, and service imagery.',
    ...
    supportedActions: ['add service', 'edit service', 'set service active state'],
    knownFailureModes: ['service missing or inactive in booking flow', 'service save validation fails'],
    allowedGuidance: ['point owners to Dashboard -> Services', 'explain active service requirement for bookings'],
    escalationBoundaries: ['technical defects when active services do not appear or persist correctly'],
    keywords: ['service', 'services', 'duration', 'price', 'service inactive', 'service not found'],
  ...
  },
  {
    ...
    summary: 'Weekly hours and blocked-time configuration that controls public slot availability.',
    ...
    supportedActions: ['set working hours', 'toggle weekdays', 'add blocked time', 'delete blocked time'],
    knownFailureModes: ['no bookable slots', 'blocked time ignored', 'opening hours missing'],
    allowedGuidance: ['point owners to Dashboard -> Availability', 'explain active weekday and blocked-time logic'],
    escalationBoundaries: ['technical defects when blocked time or availability state is ignored by booking availability'],
    keywords: ['availability', 'blocked time', 'working hours', 'bookable slots', 'holiday', 'no times', 'still book'],
  ...
  },
  {
    ...
    domain: 'booking_expert',
    title: 'Bookings',
    summary: 'Public booking flow, slot generation, booking API failures, and booking-state conflicts.',
    suggestedActionHref: '/availability',
    ...
    supportedActions: ['book service', 'choose slot', 'view booking conflicts'],
    ...
    keywords: ['booking', 'slot', 'bookings', 'service not found', 'slot unavailable', 'slot blocked'],
  ...
  },
  {
    ...
    domain: 'frontend_expert',
    title: 'Products',
    summary: 'Owner product management for product details, images, stock state, and digital/physical configuration.',
    ...
    supportedActions: ['add product', 'edit product', 'mark in stock', 'set digital download'],
    knownFailureModes: ['product missing at checkout', 'out of stock mismatch', 'digital delivery info missing'],
    allowedGuidance: ['point owners to Dashboard -> Products', 'explain active/in-stock/digital fields'],
    escalationBoundaries: ['technical defects when checkout or product display disagrees with saved product state'],
    keywords: ['product', 'digital', 'physical', 'out of stock', 'download link', 'product image'],
  ...
  },
  {
    ...
    domain: 'frontend_expert',
    title: 'Reviews',
    summary: 'Review visibility controls and the current documented limitation around request-review outreach.',
    ...
    supportedActions: ['publish review', 'hide review'],
    ...
    keywords: ['review', 'reviews', 'publish review', 'hide review', 'request review'],
  ...
  },
  {
    ...
    summary: 'Stripe onboarding, payment readiness, and checkout setup dependencies for products and bookings.',
    ...
    supportedActions: ['connect Stripe', 'complete onboarding', 'accept payments'],
    ...
    keywords: ['stripe', 'payouts', 'payments', 'checkout', 'business payments not configured', 'connect stripe'],
  ...
  },
  {
    ...
    summary: 'Calendar connection, reconnect, sync state, and booking event-write behavior.',
    ...
    supportedActions: ['connect calendar', 'reconnect calendar', 'sync bookings'],
    ...
    keywords: ['google calendar', 'calendar sync', 'reconnect calendar', 'calendar connected', 'not appearing there'],
  ...
  },
  {
    ...
    summary: 'Owner dashboard support inbox, owner-created support requests, and owner replies in support conversations.',
    ...
    supportedActions: ['create owner support request', 'change ticket status', 'reply in support conversation'],
    ...
    keywords: ['support inbox', 'support request', 'owner support', 'reply to message', 'admin replied', 'no ticket appears'],
    curatedDocIds: ['owner-support-inbox', 'contact-form-support']
  },
  {
