...
export const BUSINESS_THEMES: BusinessThemeDefinition[] = [
  ...
  defineTheme({
    ...
    tokens: {
      pageBg: '#0d1014',
      pageSurface: '#151922',
      pageSurfaceMuted: '#1b2230',
      pageSurfaceEmphasis: '#222c3d',
      pageCardBg: '#141923',
      pageCardMuted: '#1b2230',
      pageBorder: '#283446',
      pageBorderStrong: '#3c4c66',
      pageText: '#f4f7fb',
      pageTextSecondary: '#bfcbda',
      pageTextMuted: '#8897ad',
      accent: '#67f7d0',
      accentStrong: '#35d9bc',
      accentSoft: 'rgba(103,247,208,0.12)',
      accentContrast: '#091017',
      heroGradient: 'linear-gradient(145deg,#0a0d11 0%,#111723 46%,#1b3558 100%)',
      heroText: '#f6fbff',
      heroTextSecondary: '#d5e0eb',
      heroTextMuted: '#8ca4bf',
      heroKicker: '#67f7d0',
      heroDivider: 'rgba(103,247,208,0.22)',
      heroGlow: '#2eb6ff',
      heroGlowSoft: 'rgba(46,182,255,0.18)',
      ...
      badgeBg: '#67f7d0',
      badgeText: '#081117',
      badgeSoftBg: 'rgba(103,247,208,0.14)',
      badgeSoftText: '#bafced',
      ctaBg: '#67f7d0',
      ctaText: '#091017',
      ctaAccentBg: '#132434',
