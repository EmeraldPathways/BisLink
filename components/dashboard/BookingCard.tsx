...
function getBookingProcessingStatus(booking: BookingRecord, business: BusinessProfile) {
...
function hasCalendarRefreshToken(business: BusinessProfile) {
  return Boolean(
    business.google_cal_token &&
      ...
      (business.google_cal_token as { refresh_token?: string | null }).refresh_token
  );
}
