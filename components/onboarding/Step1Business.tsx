...
export function Step1Business() {
  return (
    <div className="space-y-4">
      <div>
        <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--color-gold-dark)]">Step 1 of 6</p>
      ...
      <textarea className="min-h-[110px] w-full rounded-2xl border border-[var(--color-border)] px-4 py-4" defaultValue="Movement coaching for real people." />
