      ...
      <motion.div className={shellClassName} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="button" aria-label="Close product details" className="flex h-8 w-8 items-center justify-center rounded-[10px] bg-[var(--surface-3)]" onClick={onClose}>
              <X className="h-4 w-4" />
            </button>
          </div>
          <div className="mt-4 flex h-[140px] items-center justify-center rounded-[18px] bg-[linear-gradient(135deg,#F7F4EF,#EEE9DF)]">
            <Package className="h-12 w-12 text-[var(--color-text-tertiary,#aaa)]" strokeWidth={1.25} />
          </div>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm font-medium text-[var(--gold-dark)]">
