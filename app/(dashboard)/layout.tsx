    ...
    <div className="min-h-screen bg-[var(--color-bg)] md:flex">
      <aside className="hidden w-60 flex-col justify-between border-r border-[var(--color-border)] bg-white p-5 md:flex">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--color-text-secondary)]">{demoBusiness.name}</p>
        ...
        <div className="space-y-3">
          ...
          <Link href={`/${demoBusiness.slug}`} className="block rounded-2xl bg-[var(--color-void)] px-4 py-3 text-center text-sm font-semibold text-white">
            View My Link →
          </Link>
